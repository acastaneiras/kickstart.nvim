return {
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>rs', open_scooter, { desc = 'Open scooter' })
      vim.keymap.set('v', '<leader>rr', '"ay<ESC><cmd>lua OpenScooterSearchText(vim.fn.getreg("a"))<CR>', { desc = 'Search selected text in scooter' })
